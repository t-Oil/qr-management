                ...
                <div class="card">
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-head-fixed text-nowrap">
                            ...
                            <tr>
                                <th>ลำดับ</th>
                                <th>รหัสประเภทชั่ง</th>
                                <th>ชื่อประเภทชั่ง</th>
                                <th>สถานะ</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="code">รหัสประเภทชั่ง</label>
                        <input type="text" class="form-control" id="code" placeholder="กรอกรหัสประเภทชั่ง">
                        <span class="invalid-feedback" id="err-code"></span>
                    </div>
                    <div class="form-group">
                        <label for="name">ชื่อประเภทชั่ง</label>
                        <input type="text" class="form-control" id="name" placeholder="กรอกชื่อประเภทชั่ง">
